...
Директории *Libs* и *Includes* переместите в папку проекта.
Содержимое директории *Shaders* распределите между папками сборки проекта с учетом конфигурации (либо содержимое папки *Shaders* скопируйте в корневую папку решения, если папки сборки не изменялись, то файлы скомпилированных шейдеров будут распределены корректно.
